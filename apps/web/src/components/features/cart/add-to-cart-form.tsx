...
const FORM_ID = 'add-to-cart-form';
...
export function AddToCartForm({ product, wishlist }: { product: Product; wishlist?: ReactNode }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/*
      The submit button lives outside the form and points back at it with the
      `form` attribute, so the wishlist control — a separate form — can sit beside
      it. Nesting one form inside another is invalid HTML and the browser would
      discard the inner one; this keeps both real forms, side by side.
    */}
