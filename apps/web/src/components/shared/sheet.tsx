...
type SheetRef = ComponentRef<typeof SheetPrimitive.Overlay>;
...
type SheetContentRef = ComponentRef<typeof SheetPrimitive.Content>;

interface SheetContentProps
  extends
    ComponentPropsWithoutRef<typeof SheetPrimitive.Content>,
    VariantProps<typeof sheetVariants> {
  ref?: Ref<SheetContentRef>;
}
...
type SheetTitleRef = ComponentRef<typeof SheetPrimitive.Title>;

type SheetTitleProps = ComponentPropsWithoutRef<typeof SheetPrimitive.Title> & {
  ref?: Ref<SheetTitleRef>;
};
...
type SheetDescriptionRef = ComponentRef<typeof SheetPrimitive.Description>;

type SheetDescriptionProps = ComponentPropsWithoutRef<typeof SheetPrimitive.Description> & {
  ref?: Ref<SheetDescriptionRef>;
};
...
const Sheet = composeCompoundComponent(SheetRoot, {
  Portal: SheetPortal,
